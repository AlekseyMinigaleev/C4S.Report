    ...
    public partial class Cteate_UserAuthentification_table : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                INSERT INTO [UserAuthentication] (Id, UserId, PasswordHash, PasswordSalt,RefreshToken, Password)
                SELECT NEWID(), Id, CAST(REPLICATE(CHAR(0), 16) AS VARBINARY(16)), CAST(REPLICATE(CHAR(0), 16) AS VARBINARY(16)),RefreshToken,Password
                FROM [User]
            ");
